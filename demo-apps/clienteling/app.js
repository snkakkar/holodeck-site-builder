...
function applyBrand() {
  ...
  // Real company logo: swap the cart glyph in each brand-row mark for the image.
  if (b.logoImage) {
    document.querySelectorAll(".brand-row .tw-mark").forEach((mark) => {
      if (mark.querySelector(".brand-logo-img")) return;
