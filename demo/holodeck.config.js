...
// ╚═══════════════════════════════════════════════════════════════╝
  ...
  builderPlan: {
    ...
    cxComponents: [],
    slides: [
      // Default chapter-opener — every project gets one of these
      // injected automatically by demo-deck-renderer.js if missing,
      // but we keep it here so the SE can edit copy in the Builder.
      { order:  1, id: "demo-chapter-opener", title: "Every relationship begins<br/>with a single <em>moment.</em>", layout: "chapterOpener", sectionId: "demo" },
      { order:  2, id: "demo-hero",       title: "Six months. One agentic journey.",                 layout: "hero",              sectionId: "demo", capabilities: ["Marketing Cloud","Commerce Cloud","Agentforce"] },
      { order:  3, id: "demo-foundation", title: "Why this matters",                                  layout: "storyFoundation",   sectionId: "demo" },
      { order:  4, id: "demo-twostate",   title: "From today to a connected future.",                 layout: "currentFutureState",sectionId: "demo" },
      { order:  5, id: "demo-scene",      title: "One visit. One email.",                             layout: "scenePhoto",        sectionId: "demo" },
      { order:  6, id: "demo-persona",    title: "Meet the customer at the center of the story.",     layout: "personaCard",       sectionId: "demo" },
      { order:  7, id: "demo-timeline",   title: "One journey. Every channel. Always personal.",      layout: "journeyTimeline",   sectionId: "demo" },
      { order:  8, id: "demo-profile",    title: "Who is she, really?",                               layout: "unifiedProfile",    sectionId: "demo" },
      { order:  9, id: "demo-device",     title: "Browse becomes a personal recommendation.",         layout: "deviceMoment",      sectionId: "demo", deviceFrame: "laptop" },
      { order: 10, id: "demo-agent",      title: "She left. We noticed.",                             layout: "agentConversation", sectionId: "demo" },
      { order: 11, id: "demo-arch",       title: "One platform. Every layer.",                        layout: "architecture",      sectionId: "demo" },
      { order: 12, id: "demo-kpi",        title: "Why it matters.",                                   layout: "kpiScorecard",      sectionId: "demo" },
      { order: 13, id: "demo-exec",       title: "Three things that compound.",                       layout: "executiveSummary",  sectionId: "demo" },
    ],
  },
