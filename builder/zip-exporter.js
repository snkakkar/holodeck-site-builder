...
(function (global) {
  ...
  function generateReadme(state) {
    ...
    return [
      ...
      "## Quick start",
      "",
      "**Preferred — open in your browser.** Unzip this folder and double-click",
      "`demo/index.html`. It runs as-is in any modern browser — no server, no build.",
      "",
  ...
  function generateHowToRun(state) {
    return [
      ...
      "",
      "## Run it — open in your browser (recommended)",
      "",
      "1. Unzip this folder.",
      "2. Double-click `demo/index.html` (or drag it into Chrome).",
      "",
      "That's it — the demo runs as-is in any modern browser. No install,",
      "no local server, no build step.",
      "",
      "## What you'll see",
      "",
