...
- Shopper Agent:           https://aubreydemo.com/scene/1060/frame  (agent, mobile)`;
  ...
  const PERSONA_COPY_PROMPT = [
    ...
    "  ],",
    '  "wishlist": [',
    '    { "name": "<consumer product ≤4 words>", "detail": "<short shopper context, e.g. \\"Saved to cart · price-drop trigger\\">" },',
    '    { "name": "<consumer product ≤4 words>", "detail": "<short shopper context>" },',
    '    { "name": "<consumer product ≤4 words>", "detail": "<short shopper context>" }',
    "  ]",
    "}",
    "",
    ...
    "3. WISHLIST = CONSUMER products/services THIS persona would personally shop",
    "   for and buy — real, believable retail items, tailored to the industry:",
    ...
    "   Each name ≤ 4 words. detail = a short shopper-context phrase.",
